...
- Jellyfin version 10.10 or higher
- Jellyfin Plugin [MediaSegments API](https://github.com/intro-skipper/jellyfin-plugin-ms-api) (This is only required for version 10.10)
